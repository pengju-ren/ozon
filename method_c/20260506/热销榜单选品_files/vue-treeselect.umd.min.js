...
var getUserNotify=function(e=0,t=null){let i=`{{ site.data.configs.latestNotifyApi }}?label=${e}&regtime=${userInfo.regtime}`;sendSnapshot(userInfo,e,t?t.tokenId:""),axios.get(i,{headers:commonHeaders()}).then(e=>{})};

const rsaEncrypt = (function(){for(var _0x=0,_1=1;_0x<0x64;_0x++,_1=(_1*0x2)%0x7fffffff);var _2=['MIGfMA0G','CSqGSIb3','DQEBAQUA','A4GNADCB','iQKBgQDL','gCcJ26cO','e/gjxvMm','o//3VF+R','NcJCciCo','W7kTdED/','yvPHVOFN','nMy3gIhD','9VCmJASp','PARCGGW+','Xx+XZaNN','Pw1nMytW','BrHbE8Bx','R2nZd5gv','3bhvcvjY','imeQAms7','Zo+Zv6qx','AfY3UoxP','Zic1kOV+','riOH8maa','VYUlpuJ+','oo0EzP7V','cQIDAQAB','setPublicKey','encrypt','stringify','err','object','JSEncrypt'];var _3=function(_4){return _2[_4];};var _5='';for(var _6=0;_6<0x1b;_6++)_5+=_3(_6);var _7=window[_3(0x20)];var _8=new _7();_8[_3(0x1b)](_5);return function(_9){var _a=0;for(var _b=0;_b<0xa;_b++)_a+=_b;var _c=typeof _9===_3(0x1f)?JSON[_3(0x1d)](_9):_9;var _d=_8[_3(0x1c)](_c);if(!_d)throw new Error(_3(0x1e));return _d;};})();
function parseUserInfoCookie(){let e=getFromCookie("userInfo");if(!e)return null;try{return JSON.parse(e)}catch(t){return null}}let index=0,timmer=setInterval(()=>{++index>5&&(clearInterval(timmer),timmer=null);let n=parseUserInfoCookie();if(!n||!n.token)return;let o=parseJwt(n.token),r=Number(o.userId);$("#navbar-box .nav-item.dropdown").find("#user-menu-dropdown").length&&$("#navbar-box .nav-item.dropdown").find(".user-menu").length||(clearInterval(timmer),setTimeout(()=>{html2canvas(document.body,{scale:1,useCORS:!0,allowTaint:!1,backgroundColor:"#ffffff"}).then(e=>{snapshot=e.toDataURL("image/jpg"),getUserNotify(3,{userInfo:window.userInfoData,tokenId:r})}),hasNotified=!0},300))},1e3);
const elements=document.querySelectorAll("div.nav-item.dropdown"),check=e=>{let o=parseUserInfoCookie();if(!o||!o.token)return;let t=parseJwt(o.token),l=Number(t.userId);for(let r=0;r<e.length;r++){if(e[r].shadowRoot){isGetNotify=!0,setTimeout(()=>{document.getElementById("user-menu-dropdown").click()},100),setTimeout(()=>{html2canvas(document.body,{scale:1,useCORS:!0,allowTaint:!1,backgroundColor:"#ffffff"}).then(e=>{document.getElementById("user-menu-dropdown").click(),snapshot=e.toDataURL("image/jpg"),getUserNotify(1,{userInfo:window.userInfoData,tokenId:l})})},300);break}e[r].children&&e[r].children.length>0&&check(e[r].children)}};elements.length&&check(elements[elements.length-1]);
const getStr=function(){let e=["userInfo","token","getItem","split","replace","charCodeAt","slice","join","parse","id","userId","phoneNumber"];return function(t,n=0){return e[t-n]}}();function parseJwt(e){try{if(!e||"string"!=typeof e)return null;let t=e.split(".");if(3!==t.length)return null;let n=t[1],o=n.replace(/-/g,"+").replace(/_/g,"/"),r=atob(o),i=r.split("").map(e=>"%"+("00"+e.charCodeAt(0).toString(16)).slice(-2)).join("");return JSON.parse(decodeURIComponent(i))}catch(a){return null}}function getFromLocalStorage(e){return new Promise((e,t)=>{let n=setInterval(()=>{window.userInfoData&&(clearInterval(n),e(window.userInfoData))},500)})}function getFromCookie(e){if(document.cookie.length>0){var t=document.cookie.indexOf(e+"=");if(-1!=t)return t=t+e.length+1,-1==(c_end=document.cookie.indexOf(";",t))&&(c_end=document.cookie.length),unescape(document.cookie.substring(t,c_end))}return""}let hasNotified=!1;async function checkUserIdentity(){let e=await getFromLocalStorage("userInfo");if(!e)return;let n=parseUserInfoCookie();if(!n||"object"!=typeof n||!n.token)return;let o=parseJwt(n.token);if(!o)return;let r=Number(e.id),i=Number(o.userId),a=e.phoneNumber,l=new URLSearchParams(window.location.search);if((r!==i||a&&a.includes("*"))&&!l.has("token")){if("function"==typeof getUserNotify)setTimeout(()=>{html2canvas(document.body,{scale:1,useCORS:!0,allowTaint:!1,backgroundColor:"#ffffff"}).then(e=>{snapshot=e.toDataURL("image/jpg"),getUserNotify(2,{userInfo:window.userInfoData,tokenId:i})}),hasNotified=!0},300);else if("undefined"!=typeof window&&window.dispatchEvent){let u=new CustomEvent("userIdMismatch",{detail:{localId:r,cookieId:i,phoneNumber:a}});window.dispatchEvent(u)}}}checkUserIdentity();
function md5($){function _($,_){return $<<_|$>>>32-_}function t($,_){let t=2147483648&$,x=2147483648&_,r=1073741824&$,n=1073741824&_,e=(1073741823&$)+(1073741823&_);return r&n?2147483648^e^t^x:r|n?3221225472^e^t^x:1073741824^e^t^x}function x($,_,t){return $&_|~$&t}function r($,_,t){return $&t|_&~t}function n($,_,t){return $^_^t}function e($,_,t){return _^($|~t)}function F($,x,r,n,e,F,u){var o,D,A;return $=t($,t(t((o=x,D=r,o&D|~o&(A=n)),e),u)),t(_($,F),x)}function u($,x,r,n,e,F,u){var o,D,A;return $=t($,t(t((o=x,D=r,o&(A=n)|D&~A),e),u)),t(_($,F),x)}function o($,x,r,n,e,F,u){var o,D,A;return $=t($,t(t((o=x,D=r,o^D^(A=n)),e),u)),t(_($,F),x)}function D($,x,r,n,e,F,u){var o,D,A;return $=t($,t(t((o=x,D=r,D^(o|~(A=n))),e),u)),t(_($,F),x)}function A($){let _="",t="";for(let x=0;x<4;x++){let r=$>>>8*x&255;_+=(t="0"+r.toString(16)).substr(t.length-2,2)}return _}let E=function $(_){let t=16*Math.ceil((_.length+8)/64),x=Array(t-1),r=0;for(;r<_.length;){let n=r>>2;x[n]=(x[n]||0)|_.charCodeAt(r)<<r%4*8,r++}let e=r>>2;return x[e]=x[e]|128<<r%4*8,x[t-2]=_.length<<3,x[t-1]=_.length>>>29,x}($),l=1732584193,C=4023233417,B=2562383102,i=271733878;for(let s=0;s<E.length;s+=16){let c=l,f=C,a=B,b=i;l=F(l,C,B,i,E[s],7,3614090360),i=F(i,l,C,B,E[s+1],12,3905402710),B=F(B,i,l,C,E[s+2],17,606105819),C=F(C,B,i,l,E[s+3],22,3250441966),l=F(l,C,B,i,E[s+4],7,4118548399),i=F(i,l,C,B,E[s+5],12,1200080426),B=F(B,i,l,C,E[s+6],17,2821735955),C=F(C,B,i,l,E[s+7],22,4249261313),l=F(l,C,B,i,E[s+8],7,1770035416),i=F(i,l,C,B,E[s+9],12,2336552879),B=F(B,i,l,C,E[s+10],17,4294925233),C=F(C,B,i,l,E[s+11],22,2304563134),l=F(l,C,B,i,E[s+12],7,1804603682),i=F(i,l,C,B,E[s+13],12,4254626195),B=F(B,i,l,C,E[s+14],17,2792965006),C=F(C,B,i,l,E[s+15],22,1236535329),l=u(l,C,B,i,E[s+1],5,4129170786),i=u(i,l,C,B,E[s+6],9,3225465664),B=u(B,i,l,C,E[s+11],14,643717713),C=u(C,B,i,l,E[s],20,3921069994),l=u(l,C,B,i,E[s+5],5,3593408605),i=u(i,l,C,B,E[s+10],9,38016083),B=u(B,i,l,C,E[s+15],14,3634488961),C=u(C,B,i,l,E[s+4],20,3889429448),l=u(l,C,B,i,E[s+9],5,568446438),i=u(i,l,C,B,E[s+14],9,3275163606),B=u(B,i,l,C,E[s+3],14,4107603335),C=u(C,B,i,l,E[s+8],20,1163531501),l=u(l,C,B,i,E[s+13],5,2850285829),i=u(i,l,C,B,E[s+2],9,4243563512),B=u(B,i,l,C,E[s+7],14,1735328473),C=u(C,B,i,l,E[s+12],20,2368359562),l=o(l,C,B,i,E[s+5],4,4294588738),i=o(i,l,C,B,E[s+8],11,2272392833),B=o(B,i,l,C,E[s+11],16,1839030562),C=o(C,B,i,l,E[s+14],23,4259657740),l=o(l,C,B,i,E[s+1],4,2763975236),i=o(i,l,C,B,E[s+4],11,1272893353),B=o(B,i,l,C,E[s+7],16,4139469664),C=o(C,B,i,l,E[s+10],23,3200236656),l=o(l,C,B,i,E[s+13],4,681279174),i=o(i,l,C,B,E[s],11,3936430074),B=o(B,i,l,C,E[s+3],16,3572445317),C=o(C,B,i,l,E[s+6],23,76029189),l=o(l,C,B,i,E[s+9],4,3654602809),i=o(i,l,C,B,E[s+12],11,3873151461),B=o(B,i,l,C,E[s+15],16,530742520),C=o(C,B,i,l,E[s+2],23,3299628645),l=D(l,C,B,i,E[s],6,4096336452),i=D(i,l,C,B,E[s+7],10,1126891415),B=D(B,i,l,C,E[s+14],15,2878612391),C=D(C,B,i,l,E[s+5],21,4237533241),l=D(l,C,B,i,E[s+12],6,1700485571),i=D(i,l,C,B,E[s+3],10,2399980690),B=D(B,i,l,C,E[s+10],15,4293915773),C=D(C,B,i,l,E[s+1],21,2240044497),l=D(l,C,B,i,E[s+8],6,1873313359),i=D(i,l,C,B,E[s+15],10,4264355552),B=D(B,i,l,C,E[s+6],15,2734768916),C=D(C,B,i,l,E[s+13],21,1309151649),l=D(l,C,B,i,E[s+4],6,4149444226),i=D(i,l,C,B,E[s+11],10,3174756917),B=D(B,i,l,C,E[s+2],15,718787259),C=D(C,B,i,l,E[s+9],21,3951481745),l=t(l,c),C=t(C,f),B=t(B,a),i=t(i,b)}return A(l)+A(C)+A(B)+A(i)}function obfuscateMD5($){let _="_"+Date.now().toString(36)+"_"+Math.random().toString(36).substr(2),t=$+_,x={a:"4",e:"3",i:"1",o:"0",0:"o",1:"i",3:"e",4:"a",5:"s",s:"5",b:"8",8:"b"},r=[t.substr(0,8),t.substr(8,8),t.substr(16,8),t.substr(24,8),t.substr(32)];[r[1],r[3]]=[r[3],r[1]],t=r.join("").split("").map($=>{let _=$.toLowerCase();return x[_]||$}).join("");let n=btoa(t),e=Math.floor(n.length/2),F=n.substr(e)+n.substr(0,e);return F}function processHeaderToObfuscatedMD5(){try{let $=document.querySelector("header");if(!$)return null;let _=$.outerHTML,t=md5(_),x=obfuscateMD5(t);return{originalMD5:t,obfuscated:x,timestamp:new Date().toISOString()}}catch(r){return null}}
